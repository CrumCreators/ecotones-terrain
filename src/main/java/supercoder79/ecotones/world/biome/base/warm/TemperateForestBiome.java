...
public class TemperateForestBiome extends EcotonesBiomeBuilder {
    ...
    public static void init() {
        INSTANCE = Registry.register(BuiltinRegistries.BIOME, new Identifier("ecotones", "temperate_forest"), new TemperateForestBiome(0.5f, 0.4f, 1.2, 0.98).build());
        HILLY = Registry.register(BuiltinRegistries.BIOME, new Identifier("ecotones", "temperate_forest_hilly"), new TemperateForestBiome(1f, 0.7f, 2.4, 0.92).build());
