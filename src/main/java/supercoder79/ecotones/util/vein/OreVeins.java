...
public final class OreVeins {
    public static final OreVein IRON = new OreVein(2, 42, 8,
            Blocks.STONE.getDefaultState(), Blocks.IRON_ORE.getDefaultState(), Blocks.RAW_IRON_BLOCK.getDefaultState(),
            new OreVein.Point(0.2, -0.05));

    public static final OreVein COPPER = new OreVein(8, 54, 12,
            Blocks.STONE.getDefaultState(), Blocks.COPPER_ORE.getDefaultState(), Blocks.RAW_COPPER_BLOCK.getDefaultState(),
            new OreVein.Point(-0.2, 0.1));

    public static final OreVein GOLD = new OreVein(2, 28, 4,
            Blocks.STONE.getDefaultState(), Blocks.GOLD_ORE.getDefaultState(), Blocks.RAW_GOLD_BLOCK.getDefaultState(),
